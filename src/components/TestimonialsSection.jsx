...
const TestimonialsSection = () => {
  ...
  const TestimonialCard = ({ nameKey, positionKey, contentKey, rating, avatar, index }) => (
    <motion.div
      ...
      className="bg-white/5 backdrop-blur-xl rounded-3xl p-10 shadow-2xl border border-emerald-300/10 flex flex-col h-full hover:scale-[1.02] transition-transform duration-300"
    >
      ...
      <div className="mt-auto">
        ...
        <div className="flex items-center">
          <img 
            className="w-16 h-16 rounded-full object-cover mr-5 border-2 border-emerald-400 shadow-lg ring-2 ring-emerald-600"
            alt={t(nameKey)}
            src={avatar}
          />
          <div>
  ...
  return (
    <section
      id="temoignages"
      className="py-28 px-6 sm:px-10 bg-gradient-to-br from-emerald-900/80 via-gray-900 to-teal-900/80 text-white"
    >
      <div className="max-w-screen-xl mx-auto">
        ...
        >
          <h2 className="text-4xl sm:text-5xl font-extrabold mb-6 bg-gradient-to-r from-emerald-500 via-teal-400 to-cyan-400 text-transparent bg-clip-text drop-shadow-lg">
