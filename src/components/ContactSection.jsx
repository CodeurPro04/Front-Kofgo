    ...
    <section id="NewsLetter" className="py-20 bg-white dark:bg-gray-900">
      <div className="max-w-xl mx-auto px-6 text-center">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="text-4xl sm:text-5xl font-extrabold mb-6 bg-gradient-to-r from-emerald-500 via-teal-400 to-cyan-400 text-transparent bg-clip-text drop-shadow-lg"
        >
