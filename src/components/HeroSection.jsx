...
const HeroSection = ({ scrollToSection }) => {
  ...
  const slides = [
    ...
    },
    {
      ...
      alt: "Corporate executives shaking hands",
    },
    {
      id: 4,
      image:
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 sm:px-8 lg:px-10 text-center">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-extrabold mb-8 leading-tight text-center">
            <motion.span
              className="block text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 via-teal-400 to-cyan-400 drop-shadow-lg"
          ...
          >
            <Button
              ...
              className="group bg-gradient-to-r from-emerald-500 via-teal-400 to-cyan-400 text-white font-medium text-base px-6 py-3 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-[1.02]"
            >
