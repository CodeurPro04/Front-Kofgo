...
const resources = {
  ...
  fr: {
    translation: {
      ...
      "hero.title.line1": "Propulsez Votre Entreprise",
      "hero.title.line2": "vers de Nouveaux Sommets",
      "hero.subtitle":
        "Experts en conseil stratégique, marketing digital et transformation numérique pour votre croissance.",
      "hero.cta.explore": "Nos Expertises",
      ...
      "footer.tagline":
        "Chez KOF-GO CONSULTING, nous croyons que chaque entreprise porte en elle le potentiel d’un leadership durable. Grâce à une approche alliant excellence stratégique, innovation pragmatique et accompagnement humain, nous co-construisons avec vous des trajectoires de transformation puissantes, adaptées à vos enjeux et vos ambitions.",
      ...
      "footer.links.company.careers": "Carrières chez KofGo",
      ...
      "footer.rightsReserved": "Tous droits réservés. Conçu avec passion.",
      "footer.developedBy": "Site développé par Hostinger Horizons.",

      "chatbot.header": "Assistant KofGo",
      "chatbot.welcome":
        "Bonjour ! Je suis l'assistant KofGo. Comment puis-je vous aider aujourd'hui ?",
      ...
      "chatbot.responses.servicesInfo":
        "Nous proposons des services en Stratégie d'Entreprise, Transformation Digitale, Leadership, Excellence Opérationnelle, Innovation et Cybersécurité. Lequel vous intéresse ?",
      "chatbot.responses.contactInfo":
        "Vous pouvez nous contacter via le formulaire sur notre site, par téléphone au +33 1 23 45 67 89 ou par email à contact@kofgoconsulting.com.",
      "chatbot.responses.quoteInfo":
        "Pour un devis personnalisé, veuillez remplir le formulaire de contact ou nous appeler. Nous serons ravis de discuter de votre projet !",
      "chatbot.responses.thankyouReply":
